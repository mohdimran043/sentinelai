...
### 2. There is no web CI

`.github/workflows/ci.yml` runs Python only. The console's tests, `tsc -b` and
`vite build` are entirely ungated. Run them by hand before merging web changes.
